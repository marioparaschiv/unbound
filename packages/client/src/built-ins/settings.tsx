import type { RegisterSettingsEntriesPayload, SettingsEntry } from '@unbound-app/types/api/settings';
import { CLIENT_NAME, DispatchTypes, Screens } from '~/lib/constants';
