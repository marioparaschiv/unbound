import { ManagerNames, ManagerType, type ManagerKind } from '~/lib/constants';
...
class Manager<T extends any, EventMap extends DefaultEventMap = DefaultEventMap> extends EventEmitter<EventMap> {
