...
export function buildCommands(caller: string, cmds: Omit<UnboundCommand, '__CALLER__' | '__UNBOUND__'>[]): UnboundCommand[] {
...
export function registerCommands(caller: string, cmds: Omit<UnboundCommand, '__CALLER__' | '__UNBOUND__'>[]): void {
