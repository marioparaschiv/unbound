import type { FindInTreeOptions, FindInTreePredicate } from '@unbound-app/types/utils';
 ...
 */
function findInTree<T = any>(tree: Record<any, any> | unknown[], predicate: FindInTreePredicate, options?: FindInTreeOptions): T | undefined {
