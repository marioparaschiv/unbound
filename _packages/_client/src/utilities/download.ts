import type { DCDFileManagerEncoding } from '@unbound-app/types/discord/native';
 ...
 */
async function download(url: string, path: string, encoding: DCDFileManagerEncoding = 'utf8', signal?: AbortSignal) {
